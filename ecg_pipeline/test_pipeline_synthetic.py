...
from ecg_pipeline.ecg_pipeline_core import MODELS_DIR, RISK
from ecg_pipeline.synthetic_ecg import generate_scenario
...
def test_afib_like():
    ...
    assert "AFIB_SUSPECTED" in rhythm_kinds, (
        f"AFIB_LIKE scenario (ground truth RR CV ~= {gt.afib_rr_cv_target:.3f}, rule threshold 0.15) did not "
