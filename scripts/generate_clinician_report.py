...
# docs/CLASSIFIER_EVAL_MITDB_SVDB_2026-08-03.md -- production classifier, DS2
# held-out, 45,881 beats, recomputed 2026-08-03 under current code. Real
...
# The model file is unchanged; the shift from the previously-published figures
# comes from feature-path changes (segment_beats/to_target_rate/robust_zscore),
# so re-run eval-classifier and update here when that path changes.
CLASSIFIER_METRICS = {
    "N": {"sensitivity": 0.966, "precision": 0.965, "f1": 0.966, "support": 40711},
    "S": {"sensitivity": 0.140, "precision": 0.165, "f1": 0.152, "support": 1795},
    "V": {"sensitivity": 0.907, "precision": 0.765, "f1": 0.830, "support": 3005},
    "F": {"sensitivity": 0.003, "precision": 0.083, "f1": 0.005, "support": 363},
